...
public class Solver
{
    private static int COLUMN_SIZE = 324;
    ...
    private DoubleOpt[] opt = {
                                 Condition.getColumn1,
                                 Condition.getColumn2,
                                 Condition.getColumn3,
                                 Condition.getColumn4,
                              };
    ...
    {
        int getColumn(int i, int j, int k);
    }

    class Condition
    {
        public static int getColumn1(int i, int j, int k)
        {
            return 1 + i * 9 + k;
        }
        public static int getColumn2(int i, int j, int k)
        {
            return 82 + j * 9 + k;
        }
        public static int getColumn3(int i, int j, int k)
        {
            return 163 + square[i, j] * 9 + k;
        }
        public static int getColumn4(int i, int j, int k)
        {
            return 244 + i * 9 + j;
        }
    }
    delegate int DoubleOpt(int i, int j, int k);
    ...
    public bool dfs(int k)
    {
        if (k > 325) return true;
        int s = int.MaxValue, c = 0;
